    ...
    <div class="bg-white rounded-md shadow overflow-hidden max-w-3xl">
      <form @submit.prevent="store">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          <!-- <select-input v-model="form.name" :error="form.errors.name" class="pr-6 pb-8 w-full lg:w-1/2" label="Name">
            <option :value="null" />
           ...
           <select-input v-model="form.name" :error="form.errors.name" class="pr-6 pb-8 w-full lg:w-1/2" label="Client Name">
            <option :value="null" />
            <option v-for="setting in settings" :key="setting.id" :value="setting.id">{{ setting.identifier}}</option>
          </select-input>
          ...
          <text-input type="number" v-model="form.tin" :error="form.errors.tin" class="pr-6 pb-8 w-full lg:w-1/2" label="Tin Number" />
